...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(value) => "${value}p必要";

  static m2(param1, param2) => "https://docs.google.com/forms/d/e/1FAIpQLSfV9XvQt7zKR8QwnxACOA6eFqSxKkH_PfPEWrJrAnIarPCNEQ/viewform?usp=pp_url&entry.599124620=${param1}&entry.1644757972=${param2}";
  ...
  static m6(value) => "${value}p必要";

  static m7(value) => "保有ポイント：${value}";

  static m8(value) => "${value} posts";

  static m9(value) => "${value}は必須です";
  ...
  static m20(count) => "${count}人がこの投稿を見て笑顔になりました！";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "loginSignup" : MessageLookupByLibrary.simpleMessage("アカウントを作成"),
    "loginTitle" : MessageLookupByLibrary.simpleMessage("ログイン"),
    "mapTitle" : MessageLookupByLibrary.simpleMessage("マップ"),
    ...
    "pointManagerAchiveDialogTitle" : MessageLookupByLibrary.simpleMessage("おめでとうございます! 10000ポイント達成しました"),
    ...
    "postBackPhoto" : MessageLookupByLibrary.simpleMessage("背景写真"),
    "postBackPhotoGanonymize" : MessageLookupByLibrary.simpleMessage("背景写真を匿名化"),
    ...
    "postGanonymizing" : MessageLookupByLibrary.simpleMessage("背景写真を匿名化しています"),
    ...
    "signupLogin" : MessageLookupByLibrary.simpleMessage("すでにアカウントお持ちの方はこちら"),
    ...
    "signupMarketplaceUsername" : MessageLookupByLibrary.simpleMessage("マーケットプレイス ユーザ名（オプション）"),
    ...
    "themeCreateBackPhoto" : MessageLookupByLibrary.simpleMessage("背景写真"),
    "themeCreateBackPhotoGanonymize" : MessageLookupByLibrary.simpleMessage("匿名化処理"),
    "themeCreateBackPhotoNoEdit" : MessageLookupByLibrary.simpleMessage("無加工"),
    ...
    "themeCreateSmilePhotoFacing" : MessageLookupByLibrary.simpleMessage("無加工"),
